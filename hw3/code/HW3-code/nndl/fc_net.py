...
class TwoLayerNet(object):
  ...
  def __init__(self, input_dim=3*32*32, hidden_dims=100, num_classes=10,
    ...
    # randn gives distribution from standardized normal distribution with mean 0 and variance 1
  ...
  def loss(self, X, y=None):
    ...
    # cache: (x, w, b)
    out_affine_1_relu, cache_affine_1_relu = affine_relu_forward(X, self.params['W1'], self.params['b1'])
    scores, cache_affine_2 = affine_forward(out_affine_1_relu, self.params['W2'], self.params['b2'])
